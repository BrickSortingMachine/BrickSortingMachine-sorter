...
class VisionService:
    def __init__(
        ...
        # logitech
        # self.camera_logitech = sorter.camera_capture.CameraCapture(camera_name='logitech_c920', recording=recording,
        #                                                            enable_multithread=True)
        # # capture 100 frames for focus to adjust
        # for i in range(20):
        #     self.camera_logitech.capture()
