...
class VisionServiceTest(test_helpers.BaseTest):
    ...
    def test_general(self):
        ...
        # check result
        self.assertTrue(belt_busy_evt.is_set())
        self.assertGreater(belt_busy_frame_index, 115)
        self.assertGreater(125, belt_busy_frame_index)
